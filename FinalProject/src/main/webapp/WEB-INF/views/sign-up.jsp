                                    ...
                                    <form action="insertMember" type="post">
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="sign__input">
                                                <input type="text" placeholder="ID" id="m_id" name="m_id" />
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Password</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="Password" id="m_pass" name="m_pass" />
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Full Name</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="Full name" id="m_name" name="m_name" />
                                                <i class="fal fa-user"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Phone Number</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="Phone number" id="m_tel" name="m_tel" />
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>E-mail</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="E-mail address" id="m_email" name="m_email" />
                                                <i class="fal fa-envelope"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Address</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="Address" id="m_addr" name="m_addr" />
                                                <i class="fal fa-envelope"></i>
                                            </div>
                                        </div>
                                        <div class="sign__input-wrapper mb-25">
                                            ...
                                            <div class="sign__input">
                                                <input type="text" placeholder="Detailed address" id="m_addr_sub" name="m_addr_sub" />
                                                <i class="fal fa-envelope"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sign__input-wrapper mb-25">
                                            <h5>Postal Code</h5>
                                            <div class="sign__input">
                                                <input type="text" placeholder="Postal code" id="m_post" name="m_post" />
                                                <i class="fal fa-envelope"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sign__action d-flex justify-content-between mb-30">
                                            <div class="sign__agree d-flex align-items-center">
                                                ...
                                                <label class="m-check-label" for="m-agree">I agree to the <a href="#">Terms & Conditions</a> </label>
                                            </div>
                                        </div>
