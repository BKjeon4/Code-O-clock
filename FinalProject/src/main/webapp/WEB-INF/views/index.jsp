                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                            <div class="section__title-wrapper mb-45">
                                <h2 class="section__title">
                                    Explore <br />Our <span class="yellow-bg">Popular <img src="assets/img/shape/yellow-bg-2.png" alt="" /> </span>Courses
                                </h2>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-4 offset-xxl-4">
                            <div class="section__title-wrapper mb-60 text-center">
                                <h2 class="section__title">
                                    Current <span class="yellow-bg yellow-bg-big">Events<img src="assets/img/shape/yellow-bg.png" alt="" /></span>
                                </h2>
                    ...
                    <div class="row">
                        <div class="col-xxl-4 offset-xxl-4">
                            <div class="section__title-wrapper mb-60 text-center">
                                <h2 class="section__title">
                                    Simple <br />
                                    All Inclusive <span class="yellow-bg yellow-bg-big">Pricing<img src="assets/img/shape/yellow-bg.png" alt="" /></span>
                                </h2>
